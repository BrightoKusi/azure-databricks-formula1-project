...
final_df = race_results_df.select(col('race_year'), col('race_name'), col('race_date'), col('circuit_location'),col('driver_name'),col('driver_number'), col('driver_nationality'), col('team'), col('grid'), col('fastest_lap'), col('race_time'), col('points'), col('position'))\
