...
# MAGIC %md
# MAGIC ### join races_circuits_df to results, drivers and constructors
...
# MAGIC %md
# MAGIC ### write merged data to table
...
merge_delta_df(final_df, "f1_presentation", "race_results", presentation_folder_path, merge_condition, "race_id")
